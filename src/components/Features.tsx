    ...
    <section id="features" className="relative py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 backdrop-blur-xl bg-gradient-to-r from-blue-500/10 to-cyan-400/10 border border-white/60 rounded-3xl p-8 md:p-12 shadow-xl text-center">
          ...
          <button className="px-10 py-4 bg-gradient-to-r from-blue-500 to-cyan-400 text-white rounded-full font-semibold shadow-2xl shadow-blue-300/50 hover:shadow-blue-400/60 transition-all duration-300 hover:scale-105">
            Get Started Today
          </button>
        </div>
      </div>
